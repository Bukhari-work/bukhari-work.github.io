...
{
  (() => {
    const skills = ["React", "Next.js", "JavaScript", "TypeScript", "HTML", "CSS", "Tailwind CSS", "Node.js", "Git"];
      ...
      <section id="skills" className="py-20 transition-colors duration-300">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          {skills.map((skill, index) => (
            <span key={index} className="bg-border dark:bg-darkmode-border text-dark dark:text-white px-3 py-1 rounded-full text-sm">
              {skill}
            </span>
          ))}
        </div>
